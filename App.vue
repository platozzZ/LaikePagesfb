<script>
	...
	export default {
		...
		onLaunch: function (options) {
			...
			//    alert("app-access_id-"+uni.getStorageSync("access_id"));
			var me = this
			...
			if(now_url.indexOf('?') != -1){ // 切割出参数  
				...
				obj['phone']&&obj['channel']&&me.$loginFrom._loginH5(me,'',true);

				//退出操作
				if(!obj['phone']&&obj['channel']){
					me.$loginFrom._loginOutH5(me);
				}
